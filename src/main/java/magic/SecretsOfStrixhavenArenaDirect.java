...
public class SecretsOfStrixhavenArenaDirect extends MagicEvent {
    public SecretsOfStrixhavenArenaDirect() {
        super(7, 2, new CashAmount(BigDecimal.valueOf(6000), Currency.GEMS), Map.of(
                ...
                6, Set.of(new CashPrice(new CashAmount(BigDecimal.valueOf(10800L), Currency.GEMS))),
                7, Set.of(new CashPrice(new CashAmount(BigDecimal.valueOf(320), Currency.EURO)))
        ));
    }
